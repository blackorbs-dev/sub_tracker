...
class TextInputField extends StatefulWidget {
  const TextInputField({
    ...
    this.formKey, this.validator,
    this.iconAssetName, this.controller
  });
  ...
  Widget build(BuildContext context) {
    return Material( // required for using Hero animation
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: widget.iconAssetName == null ? null : Padding(
              padding: const EdgeInsets.fromLTRB(12, 12, 6, 12),
              child: SvgIcon(widget.iconAssetName!, color: context.theme.colors.foreground,)
          ),
          hintStyle: context.theme.textTheme.bodySmall
            .withColor(context.theme.colors.foreground.withValues(alpha: 0.7)),
          border: outlinedBorder(color: context.theme.colors.foreground),
          enabledBorder: outlinedBorder(color: context.theme.colors.foreground),
          focusedBorder: outlinedBorder(color: context.theme.colors.foreground),
